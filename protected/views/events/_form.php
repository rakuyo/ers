...
<div class="row"><?php echo $form->datetimepickerRow($model,'datetime',array('options'=>array('format'=>'yyyy-mm-dd hh:ii','todayBtn'=>'linked','todayHighlight'=>true,'autoclose'=>true,'showMeridian'=>true,'minuteStep'=>1),'htmlOptions'=>array('class'=>'span12','placeholder'=>'Date/Time')),array('prepend'=>'<i class="icon-calendar"></i>','append'=>'<i class="icon-time"></i>')); ?></div>
